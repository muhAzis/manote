...
const EmptyShelf = () => {
  return (
    <div className="empty-shelf-container">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 790 701.99219" xmlnsXlink="http://www.w3.org/1999/xlink">
        <path
        ...
        />
        <path d="M439.411,441.28564a10.74274,10.74274,0,0,0-14.42255,7.9585l-88.25427,47.98779,15.51715,17.46436,81.96-52.59912a10.80091,10.80091,0,0,0,5.19971-20.81153Z" transform="translate(-205 -99.00391)" fill="var(--clr-acc-skin)" />
        <polygon points="211.903 687.551 222.9 680.438 200.697 634.635 184.466 645.133 211.903 687.551" fill="var(--clr-acc-skin)" />
        <path
          ...
          fill="var(--clr-acc-accent2)"
        />
        <polygon points="88.511 689.206 101.608 689.206 107.841 638.688 88.511 638.688 88.511 689.206" fill="var(--clr-acc-skin)" />
        <path
          ...
          fill="var(--clr-acc-accent2)"
        />
        <path d="M594,197.99609H567a2.5,2.5,0,0,1,0-5h27a2.5,2.5,0,0,1,0,5Z" transform="translate(-205 -99.00391)" fill="var(--clr-acc-accent2)" />
        <path d="M594,204.99609H567a2.5,2.5,0,0,1,0-5h27a2.5,2.5,0,0,1,0,5Z" transform="translate(-205 -99.00391)" fill="var(--clr-acc-accent2)" />
        <path d="M594,211.99609H567a2.5,2.5,0,0,1,0-5h27a2.5,2.5,0,0,1,0,5Z" transform="translate(-205 -99.00391)" fill="var(--clr-acc-accent2)" />
        <path
          ...
          fill="var(--clr-acc-accent2)"
        />
        <path d="M649.00537,289.99609H600.5a11,11,0,0,1,0-22h48.50537a11,11,0,0,1,0,22Z" transform="translate(-205 -99.00391)" fill="var(--clr-acc-accent2)" />
        <path d="M797.5,313.99609h-202a6,6,0,0,1,0-12h202a6,6,0,0,1,0,12Z" transform="translate(-205 -99.00391)" fill="var(--clr-acc-second)" />
        <path d="M669.7002,337.99609H595.5a6,6,0,0,1,0-12h74.2002a6,6,0,0,1,0,12Z" transform="translate(-205 -99.00391)" fill="var(--clr-acc-second)" />
        <path d="M649.00537,555.99609H600.5a11,11,0,0,1,0-22h48.50537a11,11,0,0,1,0,22Z" transform="translate(-205 -99.00391)" fill="var(--clr-acc-accent2)" />
        <path d="M797.5,579.99609h-202a6,6,0,0,1,0-12h202a6,6,0,0,1,0,12Z" transform="translate(-205 -99.00391)" fill="var(--clr-acc-second)" />
        <path d="M669.7002,603.99609H595.5a6,6,0,0,1,0-12h74.2002a6,6,0,0,1,0,12Z" transform="translate(-205 -99.00391)" fill="var(--clr-acc-second)" />
        <path d="M649.00537,678.99609H600.5a11,11,0,0,1,0-22h48.50537a11,11,0,0,1,0,22Z" transform="translate(-205 -99.00391)" fill="var(--clr-acc-accent2)" />
        <path d="M797.5,702.99609h-202a6,6,0,0,1,0-12h202a6,6,0,0,1,0,12Z" transform="translate(-205 -99.00391)" fill="var(--clr-acc-second)" />
        <path d="M669.7002,726.99609H595.5a6,6,0,0,1,0-12h74.2002a6,6,0,0,1,0,12Z" transform="translate(-205 -99.00391)" fill="var(--clr-acc-second)" />
        <path
        ...
        <path
          ...
          fill="var(--clr-acc-second)"
        />
        <circle cx="117.102" cy="309.88012" r="26.2388" fill="var(--clr-acc-skin)" />
        <path
        ...
        <path
          ...
          fill="var(--clr-acc-main)"
        />
        <path d="M757.5,443.49609h-249a6,6,0,0,1,0-12h249a6,6,0,0,1,0,12Z" transform="translate(-205 -99.00391)" fill="var(--clr-acc-second)" />
        <path d="M629.7002,467.49609H508.5a6,6,0,0,1,0-12H629.7002a6,6,0,0,1,0,12Z" transform="translate(-205 -99.00391)" fill="var(--clr-acc-second)" />
      </svg>
      <p className="empty-description">Your shelf is empty, add some new notes!</p>
    </div>
  );
};
